...
//    Addresses "Bug 2" which involved duplicate products being created instead of updated. This implementation ensures that an existing product record is modified based on its `product_id`.
    @Override
